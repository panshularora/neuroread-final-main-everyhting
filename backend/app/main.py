...
# Assistive (mounted under /assistive)
safe_include("app.routes.assistive.vocab", "vocab", prefix="/assistive")
safe_include("app.routes.assistive.tts", "tts", prefix="/assistive")
safe_include("app.routes.assistive.simplify", "simplify", prefix="/assistive")
safe_include("app.routes.assistive.rewrite", "rewrite", prefix="/assistive")
safe_include("app.routes.assistive.vocab_card", "vocab_card", prefix="/assistive")
safe_include("app.routes.assistive.document", "document", prefix="/assistive")
safe_include("app.routes.assistive.tutor", "tutor", prefix="/assistive")
safe_include("app.routes.assistive.heatmap", "heatmap", prefix="/assistive")
safe_include("app.routes.assistive.concept_graph", "concept_graph", prefix="/assistive")
safe_include("app.routes.assistive.chunk", "chunk", prefix="/assistive")
safe_include("app.routes.assistive.companion", "companion", prefix="/assistive")
safe_include("app.routes.assistive.annotate", "annotate", prefix="/assistive")
safe_include("app.routes.assistive.assist", "assist", prefix="/assistive")
